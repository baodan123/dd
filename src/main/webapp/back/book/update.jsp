...
<body style="background-color: #f0f9fd;text-align: center">
	...
	<hr />
	<div align="center">
	<form action="/dd/book/update" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td><input type="hidden" name="book.id" class="el-input__inner" value="${book.id}" readonly="readonly" ></td>
					<td>名称：</td>
				...
				<tr>
					<td>所属分类：</td>
					<td>
						<select name="book.type_id" class="el-select__inner inner2">
					...
					<td>字数：</td>
					<td><input type="number" name="book.font_num" class="el-input__inner" value="${book.font_num}" ></td>
				</tr>
				...
				<tr>
					...
					<td rowspan="3">
						<label id="file_upload1_label" for="file_upload1">
							<img id="uploadimg" src="/dd/back/img/${book.cover}" alt="" width="120" height="145" />
						</label> 
				...
				<tr>
					<td>当当价：</td>
					<td><input type=number name="book.dd_price" class="el-input__inner" value="${book.dd_price }"></td>
					<td></td>
				</tr>
				<tr>
					<td>库存：</td>
				...
				<tr>
					...
					<td>编辑推荐：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.recommendation">${book.recommendation}</textarea></td>
				</tr>
				<tr>
					<td>出版社：</td>
				...
				<tr>
					<td>出版时间：</td>
					<td><input type="date" name="book.publish_date" class="el-input__inner" value="<fmt:formatDate value="${book.publish_date}" pattern="yyyy-MM-dd" />"></td>
					<td>内容简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.summary" >${book.summary}</textarea></td>
				</tr>
				<tr>
					<td>版次：</td>
				...
				<tr>
					...
					<td>作者简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.resume">${book.resume}</textarea></td>
				</tr>
				<tr>
					<td>印次：</td>
					<td><input type="text" name="book.print_time" class="el-input__inner" value="${book.print_time}"></td>
					<td></td>
				</tr>
				<tr>
					<td>ISBN：</td>
				...
				<input type="text" name="book.sales" value="${book.sales}"  hidden/>
			</table>
