...
<body
	...
	<hr />
	<div align="center">
		<form action="/dd/book/add" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>名称：</td>
				...
				<tr>
					...
					<td>字数：</td>
					<td><input type="number" name="book.font_num" class="el-input__inner"></td>
				</tr>
				...
				<tr>
					...
					<td>编辑推荐：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.recommendation"></textarea></td>
				</tr>
				<tr>
					<td>出版社：</td>
				...
				<tr>
					<td>出版时间：</td>
					<td><input type="date" name="book.publish_date" class="el-input__inner"></td>
					<td>内容简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.summary"></textarea></td>
				</tr>
				<tr>
					<td>版次：</td>
				...
				<tr>
					...
					<td>作者简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.resume"></textarea></td>
				</tr>
				<tr>
					<td>印次：</td>
					<td><input type="text" name="book.print_time" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>ISBN：</td>
