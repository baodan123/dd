	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<div class="cart gray4012">
				<a href="/dd/front/cart/cart_list.jsp">购物车</a>
			</div>
		</div>
		<span class="head_toutext" id="logininfo">
		<b>您好，欢迎光临当当网</b>
		
		[&nbsp;<a href="/dd/user/exit" class="b">登出</a>&nbsp;]
		[&nbsp;<a href="/dd/front/user/login_form.jsp" class="b">登录</a>|
		<a href="/dd/front/user/register_form.jsp" class="b">注册</a>&nbsp;]
		</span>
	</div>
