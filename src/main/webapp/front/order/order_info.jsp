	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<c:forEach var="a" items="${cart}" varStatus="stu" >
					<tr>
						<td valign="top">
							${stu.index+1}
						</td>
						...
						<td valign="top">
							${a["value"].book.dd_price}
						</td>
						<td valign="top">
							${a["value"].counts}
						</td>
						<td valign="top">
							${a["value"].book.dd_price*a["value"].counts}
						</td>
					</tr>
					</c:forEach>
